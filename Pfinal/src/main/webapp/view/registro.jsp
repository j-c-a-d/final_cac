        ...
        <section>
            ...
            <div class="row d-flex flex-column justify-content-center align-center login" >
                ...
                <form  action="../controller/guardarUsuario.jsp" method="POST">
                    ...
                    <div class="col-12 col-sm-8 col-md-6 col-lg-4 col-xl-4 mx-auto p-3"><input type="password" name="clave" id="clave" class="form-control" aria-describedby="passwoord" placeholder="Contraseña" onkeyup="validarRegistro()" required>
                ...
                <div class="f-left box">
                    ...
                    <div class="f-contenido">
                        <p>No somos la empresa de alquiler de autos exóticos promedio, y no hay dos días iguales.
                            ...
                            las personas la oportunidad de conducir el coche de sus sueños a diario. La pura alegría que
